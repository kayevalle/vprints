<?php 
	...
	$fetchproduct = mysql_query("SELECT p.product_name, o.product_id, COUNT(o.product_id) as 'best',p.product_price, p.product_price*(COUNT(o.product_id)) as 'amount' FROM order_table o,product_table p WHERE o.product_id = p.product_id GROUP BY o.product_id");
			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					...
					<div class="navbar-header">
	                    ...
	                    <a class="navbar-brand" href="#datatable">Best Sellers</a>
					</div>
					    ...
					    -->
					        ...
					        <table id="bootstrap-table" class="table">
					            <thead style="height: 50px">
					            	...
					            	<th data-field="product_qty" data-sortable="true" class="text-center">Total Quantity</th>
					            ...
					            <?php foreach ($products as $product): ?>
					                ...
					                <tr>
					                	...
					                	<td class="text-center"><?php echo $product["best"] ?></td>
					                	<td>P<?php echo $product["amount"] ?></td>
					                	<!-- <td>
