<?php 
	...
	$fetchproduct = mysql_query("SELECT * FROM product_table p, category_table c WHERE p.product_qty < 4 AND p.category_id = c.category_id");
	while ($product = mysql_fetch_assoc($fetchproduct)) {
		$products[] = $product;
	}
			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					...
					<div class="navbar-header">
	                    ...
	                    <a class="navbar-brand" href="#datatable">Low Stock Report</a>
					</div>
					    ...
					    -->
					        ...
					        <table id="bootstrap-table" class="table">
					            <thead style="height: 50px">
					            	...
					            	<th data-field="product_qty" data-sortable="true">Stock Quantity</th>
					            ...
					            <?php foreach ($products as $product): ?>
					                ...
					                <tr>
					                	...
					                	<td class="td-actions">
							                ...
							                <a href="../../controller/submit_modal.php?remove=true&id=<?php echo $product["product_id"] ?>" rel="tooltip" data-placement="top" title="Remove" class="btn btn-danger btn-simple btn-icon">
					...
					<div class="modal-body">
						<form method="post" action="../../controller/submit_modal.php">
									...
									<div class="col-md-5" >
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<p class="form-control-static prod_price"></p>
							...
							<div class="modal-footer">
								...
								<button type="submit" name="update" class="btn btn-info" value="product">Update</button>
							</div>
						</form>
						</div>
				</div>
	    ...
	    //     }
	        ...
	        $('.edit').click(function(){
	        	...
	        	.done(function(data) {
	        		...
	        		$('.prod_price').text("P"+data.product_price);
